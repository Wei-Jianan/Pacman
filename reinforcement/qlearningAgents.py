...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeActionFromQValues(self, state):
        ...
        best_action = None
        max_q_value = -999999999999999999
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def getQValue(self, state, action):
        ...
        # print features, "!!!!!!!!!!!!!!!!!!!!!!!!!"
        q_value = 0
        for key in features.sortedKeys(): #len(self.weights):
            q_value += features[key] * self.weights[key]
        return q_value
    ...
    def update(self, state, action, nextState, reward):
        ...
        # print reward
            ...
            difference = reward - self.getQValue(state, action) # + self.discount * max([self.getQValue(nextState, nextaction) for nextaction in self.getLegalActions(nextState)])) - self.getQValue(state, action)
