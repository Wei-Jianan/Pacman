...
class CornersProblem(search.SearchProblem):
    ...
    # def costFn(self, s):
    #
    # #   could be change for further use
    #     return 1
    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            #         if not next_node in visitedCorners:# successorVisitedCorners:
            #             visitedCorners.append( next_node )
            #             # successorVisitedCorners.append( next_node )
            #     successor = ((next_node, visitedCorners), action, 1)
...
def cornersHeuristic(state, problem):
    ...
    value = easyDistenceOfDots(place, unvisited_corners, problem)
    print value
...
def easyDistenceOfDots(place, dots, problem):
    distence = 9999999999
    if dots == []:
        return 0
    for dot in dots:
